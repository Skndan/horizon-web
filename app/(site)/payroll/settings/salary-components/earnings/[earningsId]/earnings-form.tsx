...
export const EarningsForm: React.FC<EarningFormProps> = ({
    ...
    const description = initialData ? 'Edit a earning.' : 'Add a new earning';
    const toastMessage = initialData ? 'Earning updated.' : 'Earning created.';
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Earning Type <span className="text-red-500">*</span></FormLabel>
                                <FormControl>
                    ...
                    <div className="grid grid-cols-2 space-x-4">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Earning Name <span className="text-red-500">*</span></FormLabel>
                                    <FormControl>
